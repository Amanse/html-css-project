...
class Pizza {
  ...
  update() {
    ...
    for (let i = this.sliceCount - 1; i > 0; i--) {
      ...
      if (i === this.sliceCount - 1) {
        ...
        this.cheese(ctx, rad, .9, ii, this.sliceSize, this.sliceDegree)
        this.cheese(ctx, rad, .6, ii, this.sliceSize, this.sliceDegree)
        this.cheese(ctx, rad, .5, ii, this.sliceSize, this.sliceDegree)
        this.cheese(ctx, rad, .3, ii, this.sliceSize, this.sliceDegree)
  ...
  cheese(ctx, rad, multi, ii, sliceSize, sliceDegree) {
